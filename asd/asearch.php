...
<body id="body" background="sources/background.png">
	...
	<div id="navBar">
		...
		<span id="navLinks">
			...
			<span><a href="aabout.html">ABOUT</a></span>
			<span><a href="acontacs.php">CONTACTS</a></span>
...
?>
                ...
                if($valueToSearch == $row['username'] || $valueToSearch == $row['snum'] ){
                	echo "<img src='", $row['username'], ".png' height='300' width='300'>";
                	echo "<h1>";
                	echo "Information</h1>";
                	echo "Name: ";
